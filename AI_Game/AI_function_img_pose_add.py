...
def classifyPose(landmarks, output_image, display=False):
    ...
    # Get angle: left shoulder, elbow, wrist    ShouZhouJiaoDu
    ...
    # Get angle: left elbow, shoulder, hip       GaZhiWoJiaoDu
    ...
    if left_knee_angle > 160 and left_knee_angle < 195 and right_knee_angle > 160 and right_knee_angle < 195 :
        ...
        if left_elbow_angle > 165 and left_elbow_angle < 195 and right_elbow_angle > 165 and right_elbow_angle < 195:
            ...
            if left_shoulder_angle > 115 and left_shoulder_angle < 155 and right_shoulder_angle > 115 and right_shoulder_angle < 155 :
            ...
            if left_shoulder_angle > 30 and left_shoulder_angle < 60 and right_shoulder_angle > 120 and right_shoulder_angle < 150 :

                label = "0135pose"

            if left_shoulder_angle > 120 and left_shoulder_angle < 150 and right_shoulder_angle > 30 and right_shoulder_angle < 60 :

                label = "0450pose"

            if left_shoulder_angle > 30 and left_shoulder_angle < 60 and right_shoulder_angle > 80 and right_shoulder_angle < 110 :

                label = "0335pose"

            if left_shoulder_angle > 80 and left_shoulder_angle < 110 and right_shoulder_angle > 30 and right_shoulder_angle < 60 :

                label = "0445pose"

            if left_shoulder_angle > 120 and left_shoulder_angle < 150 and right_shoulder_angle > 80 and right_shoulder_angle < 110 :

                label = "0350pose"

            if left_shoulder_angle > 80 and left_shoulder_angle < 110 and right_shoulder_angle > 120 and right_shoulder_angle < 150 :
